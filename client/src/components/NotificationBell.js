...
const NotificationBell = ({ 
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <svg className={`w-6 h-6 transition-transform duration-200 ${unreadCount > 0 ? 'animate-bell-shake text-yellow-400' : 'text-gray-400 dark:text-gray-500'} hover:scale-110 active:scale-95`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
